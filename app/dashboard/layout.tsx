...
const orgSwitcherAppearance = {
  ...
  elements: {
    ...
    membershipBadge: "bg-[#8B7FFF33] text-white text-[10px] rounded-full px-2 py-0.5 font-medium",
    organizationSwitcherPopoverInvitationActionsBox: "px-2",
    userPreviewMainIdentifier: "text-white text-[13px] font-semibold",
    userPreviewSecondaryIdentifier: "text-[#8B93AC] text-[11px]",
    userPreviewAvatarBox: "w-7 h-7 rounded-md",
    organizationListPreviewButton: "hover:bg-[#1F2740] rounded-lg text-white",
    organizationListPreviewItemIdentifier: "text-white",
    organizationListCreateOrganizationActionButton: "hover:bg-[#1F2740] rounded-lg text-white",
    organizationListCreateOrganizationActionButtonText: "text-white text-[13px]",
    organizationListCreateOrganizationActionButtonIcon: "text-white",
    personalWorkspaceIdentifier: "text-white text-[13px] font-semibold",
    personalWorkspacePreview: "hover:bg-[#1F2740] rounded-lg",
  },
};
